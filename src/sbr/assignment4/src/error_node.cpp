...
int main( int argc, char** argv ){
  ...
  while( nh.ok() ){
    ...
    std::cout // << std::setw(15) << "Error"
        << std::setw(15) << gaz_xyz.x - ekf_xyz.x 
	      << std::setw(15) << gaz_xyz.y - ekf_xyz.y 
	      << std::setw(15) << gaz_xyz.z - ekf_xyz.z << std::endl << std::endl << std::endl;
	  // std::cout << std::setw(15) << "EKF" 
	  //     << std::setw(15) << ekf_xyz.x
	  //     << std::setw(15) << ekf_xyz.y
	  //     << std::setw(15) << ekf_xyz.z << std::endl << std::endl << std::endl;
   //  std::cout << std::setw(15) << "gaz" 
   //      << std::setw(15) << gaz_xyz.x
   //      << std::setw(15) << gaz_xyz.y
   //      << std::setw(15) << gaz_xyz.z << std::endl << std::endl<< std::endl;
