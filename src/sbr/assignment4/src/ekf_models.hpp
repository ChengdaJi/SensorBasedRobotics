...
/**
   ...
   \param v_in     The input linear velocity command
   \param w_in     The input angular velocity command
*/
State sys_evaluate_g( const State& state_in, double v_in, double w_in );
